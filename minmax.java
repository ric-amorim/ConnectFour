...
public class minmax {
    ...
    public static int[] recursive(Board game, int depth,int play,int flag,int flag2,int[] NodeCount){
        ...
        for(int i=1;i<=7;i++){
            ...
            if(game.max[i-1]<6)
                temp = recursive(game.add(i),depth-1,play,flag*(-1),1, NodeCount);
            else
                continue;
    ...
    public static void main(String[] args){
        ...
        while(!winner(gaming,x)){
            ...
            if(i%2 == 1){
                ...
                x = recursive(gaming, 6, 0, -1, 0,nodeCount)[0];
